...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_CONFIRM_FULL_FLOW_2_STEP_LINE1,
      vars.tmp.fullAmount
    });
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_CONFIRM_FULL_FLOW_3_STEP_LINE1,
      vars.tmp.fullAddress
    });
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_CONFIRM_FULL_FLOW_4_STEP_LINE1,
      vars.tmp.feesAmount
    });
UX_LOC_STEP_CB(
...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_CONFIRM_SINGLE_FLOW_2_STEP_LINE1,
      vars.tmp.fullAmount
    });
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_CONFIRM_SINGLE_FLOW_3_STEP_LINE1,
      vars.tmp.fullAddress
    });
UX_LOC_STEP_CB(
...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_DISPLAY_PUBLIC_FLOW_2_STEP_LINE1,
...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_DISPLAY_PUBLIC_FLOW_5_STEP_LINE1,
...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_REQUEST_CHANGE_PATH_APPROVAL_FLOW_2_STEP_LINE1,
      vars.tmp_warning.derivation_path
    });
UX_LOC_STEP_CB(
...
UX_LOC_STEP_NOCB(
    ...
    bnnn_paging,
    {
      UX_REQUEST_SIGN_PATH_APPROVAL_FLOW_2_STEP_LINE1,
      vars.tmp_warning.derivation_path
    });
UX_LOC_STEP_CB(
...
UX_LOC_STEP_CB(
    ...
    {
      &C_icon_validate_14,
      UX_REQUEST_SIGN_PATH_APPROVAL_FLOW_4_STEP_LINE1
    });
